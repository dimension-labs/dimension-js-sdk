import { DimensionServiceByJsonRPC, GetDeployResult } from '../services';
...
import { DimensionHDKey } from './DimensionHDKey';
import { BigNumber } from '@ethersproject/bignumber';

export class DimensionClient {
  public nodeClient: DimensionServiceByJsonRPC;

  constructor(nodeUrl: string) {
    this.nodeClient = new DimensionServiceByJsonRPC(nodeUrl);
  }
   ...
   */
  public newHdWallet(seed: Uint8Array): DimensionHDKey {
    return DimensionHDKey.fromMasterSeed(seed);
  }
