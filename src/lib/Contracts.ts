...
const NO_CLIENT_ERR =
  'You need to either create Contract instance with dimensionClient or pass it as parameter to this function';

export class Contract {
  public contractHash?: string;
  public contractPackageHash?: string;

  constructor(public dimensionClient?: DimensionClient) {}
  ...
  public async queryContractData(
    ...
    const client = dimensionClient || this.dimensionClient;
